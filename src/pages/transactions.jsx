  ...
  return (
    <div className="transactions-dashboard">
      ...
      <div className="transactions-grid">
              ...
              <>
                <div className="transaction-header">
                  ...
                  <div className="transaction-actions">
                    <button onClick={() => handleEdit(transaction)} className="edit-icon">✏️</button>
                    <button onClick={() => handleDelete(transaction.id)} className="delete-icon">🗑️</button>
                  </div>
                </div>
        ...
        <div className="transaction-card add-transaction-card" onClick={() => setShowAddModal(true)}>
